...
import { Calendar, Twitter, Instagram, Linkedin, Github } from "lucide-react";
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-muted-foreground max-w-sm">
              Your premier platform for discovering, creating, and managing unforgettable events. Connect with your community.
            </p>
